...
function Dashboard() {
    ...
    return (
        <>
            <NotificationToast message={eventToast} onClose={() => setEventToast(null)} />
            <div className="page">
                <div className="container">
                    ...
                    {dailyMotivation && (
                        <div className="card motivation-card" style={{ marginBottom: '1.75rem', borderLeft: '4px solid var(--primary)' }}>
                            <div className="flex gap-2" style={{ alignItems: 'center' }}>
                                <span style={{ fontSize: '1.75rem' }}>💬</span>
                                <div>
                                    <p className="text-secondary text-sm">Motivación de hoy</p>
